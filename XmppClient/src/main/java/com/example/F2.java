...
//     // Almacenar mensajes por usuario
//     private Map<String, ObservableList<String>> messagesByUser = new HashMap<>();
//     private Map<String, StringBuilder> conversations = new HashMap<>();
...
//     private void updateChatArea(String userJid) {
//         chatArea.clear();
//         ObservableList<String> messages = messagesByUser.get(userJid);
//         if (messages != null) {
